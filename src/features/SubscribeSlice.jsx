...
export const getSubscribe = createAsyncThunk("subscribe/getSubscribe", async() => {
    const response = await axios.get('http://44.201.153.46:8081/api-dev/v1/subscribers', { headers: authHeader() });
...
export const deleteSubscribe = createAsyncThunk("subscribe/deleteSubscribe", async (id) => {
    await axios.delete(`http://44.201.153.46:8081/api-dev/v1/subscribers/${id}` , { headers: authHeader()}) ;
    return id;
